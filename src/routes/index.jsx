...
export default function Landing() {
  return (
    <div class="flex flex-col items-center justify-center bg-blue-300 h-screen w-screen">
      <img src="../wooshLogo.png" alt="logo" class="mt-12" />
      ...
      <img src="../horizontal_Logo.png" alt="logo" class="mt-16" />
    </div>
  );
}
